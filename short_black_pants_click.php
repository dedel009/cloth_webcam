  ...
  <section class="jumbotron text-center" style="width: 100%; float: left;">
          <div>
            <div class="card-body" style=" float: left; padding-left: 10%;">
              <img src="cloth/short_black_pants.jpg" style="width: 500px; height: 500px; " >     
            </div>
          </div>
          <div style=" float: left; margin-top: 20px; margin-left: 10px;">
            <form method="post" name="form_size">
                <p style="font-size: 30px;">검정 반바지</p>
                <hr/>
                <p style="float: left;">판매가</p>
                <p style="float: left; margin-left: 70px;">12,500원</p>
                <br/>
                <p style="float: left;">적립금</p>
                <p style="float: left; margin-left: 70px;">125P</p>
                <br/>
                <p style="float:left; margin-right: 15px;">사이즈</p>
                  ...
                  <p></p>
                  <input type="hidden" name="menu" id="menu" value="under">
...
<script type="text/javascript">
  function what_menu(){
    if($('#size').val()==""){
      ...
      var menu = $('#menu').val();
      document.form_size.action = "under_cam.php?cloth_ctg=short_black_pants";
      location.href = "under_cam.php";
    }
}
