  ...
  <section class="jumbotron text-center" style="width: 100%; float: left;">
          <div>
            <div class="card-body" style=" float: left; padding-left: 10%;">
              <img src="cloth/black_tshirts.jpg" style="width: 500px; height: 500px; " >     
            </div>
          </div>
          <div style=" float: left; margin-top: 20px; margin-left: 10px;">
            <form method="post" name="form_size">
                <p style="font-size: 30px;">검정 티셔츠</p>
                <hr/>
                <p style="float: left;">판매가</p>
                <p style="float: left; margin-left: 70px;">10,000원</p>
                <br/>
                <p style="float: left;">적립금</p>
                <p style="float: left; margin-left: 70px;">100P</p>
                <br/>
...
<script type="text/javascript">
  ...
  function what_menu(){
    if($('#size').val()==""){
      ...
      var menu = $('#menu').val();
      document.form_size.action = "top_cam.php?cloth_ctg=black_tshirts";
