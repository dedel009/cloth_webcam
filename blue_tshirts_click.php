...
<main role="main">
  <section class="jumbotron text-center" style="width: 100%; float: left;">
          <div>
            <div class="card-body" style=" float: left; padding-left: 10%;">
              <img src="cloth/choice_tshirts.jpg" style="width: 500px; height: 500px; " >     
            </div>
          </div>
          <div style=" float: left; margin-top: 20px; margin-left: 10px;">
            <form method="post" name="form_size">
                <p style="font-size: 30px;">choice 티셔츠</p>
                <hr/>
                <p style="float: left;">판매가</p>
                <p style="float: left; margin-left: 70px;">13,000원</p>
                <br/>
                <p style="float: left;">적립금</p>
                <p style="float: left; margin-left: 70px;">130P</p>
                <br/>
  ...
  <section>
          <div style="margin-left: 15%; padding-top: 15%;">
            <p>*상품설명*</p>
            <p>이 옷은 choice 문자가 있는 파란색 티셔츠입니다.</p>
            <br>
            <br>
            <br>
            <br>
...
<script type="text/javascript">
  ...
  function what_menu(){
    ...
    var menu = $('#menu').val();
    document.form_size.action = "top_cam.php?cloth_ctg=choice_tshirts";
